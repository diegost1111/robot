...
#Eliminamos  el available en el metodo constructor, reemplamos en el get_status_dict (is_available)       
#Las {}estan basados en el robot_art,tenemos que pasar todo el diccionario get_status_dict
#A la plantilla robot_art
...
#No es necesario la funcion not porque nos esta retornando true ...    
    def is_on(self):
